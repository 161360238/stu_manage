...
<body>
 <div class="x-nav">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form  id="seacherInfo" class="layui-form layui-col-md12 x-so" action="${baseurl}stuAccountList.do" method="POST">       
        
             <input type="text" name="stu_name"  value="${stu_name}" placeholder="请输入学生姓名" autocomplete="off" class="layui-input">
      ...
      <table  class="layui-table">
        ...
        <tbody>
	        ...
	        <tr>
	            ...
	            <td>${row.cname}</td>        	                   	            
	            <td class="td-manage">                	             
	              <a title="恢复账号" onclick=member_del(this,'${row.sid}') href="javascript:;">
       ...
       <itpage:page url="${baseurl}stuAccountList.do"></itpage:page>
    </div>
