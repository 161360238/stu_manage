...
<body>
 <div class="x-nav">
    ...
    <div class="x-body">
      <div class="layui-row">
        <form  id="seacherInfo" class="layui-form layui-col-md12 x-so" action="${baseurl}teaBasicInfoList.do" method="POST">                 
             <input type="text" name="stu_name"  value="${stu_name}" placeholder="请输入教师姓名" autocomplete="off" class="layui-input" style="width:200px;height:35px;margin-right:10px;">
      ...
      <table  class="layui-table">
        ...
        <tbody>
	        ...
	        <tr>
	            ...
	            <td>${row.tphone}</td>	                  	                   	            
	             <td class="td-manage">                	             	           
	              <a title="删除" onclick=member_del(this,'${row.tid}') href="javascript:;">
       ...
       <itpage:page url="${baseurl}teaBasicInfoList.do"></itpage:page>
    </div>   
    ...
    layui.use('layer', function(){
      ...
      function member_del(obj,id){
          layer.confirm('确认要删除吗？',function(index){
        	  $.ajax({
        		  url:'${baseurl}delectTeaByManager.do',
        		  type:'POST',
        		  data:{tid:id},
