               ...
               <input name="sid" type="hidden" value="${sid}" >
                <div class="layui-form-item">
                    <label for="name" class="layui-form-label">
                        <span class="x-red">*</span>加分情况
                    </label>
                    <div class="layui-input-inline">
                        <input type="text"  name="rscore"  placeholder="请输入数值" required="" lay-verify="required"
                        autocomplete="off" class="layui-input">
                    </div>
                </div>   
                  
                  <input class="layui-input" type="text" placeholder="奖励时间" name="nstime" id="start">        
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容"  name="rdesc" class="layui-textarea"></textarea>
                    </div>
                </div>               
                ...
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        <textarea placeholder="请输入内容"  name="rother" class="layui-textarea"></textarea>
                    </div>
                </div>
                <div class="layui-form-item">
