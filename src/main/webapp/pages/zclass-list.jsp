            ...
            <xblock>
		        <div class="row" style="float:right">
					<div class='form-inline'>
						<form action="${APP_PATH }/attend/selectZclassByLike.do">
            ...
            <table class="layui-table">
                ...
                <tbody>
                    ...
                    <tr>
			                        ...
			                        <td>
			                        	<span id="${item.zcid }"></span>
				                        	<script type="text/javascript">
				                        		var tid='${item.tid}';
					                        		$("#${item.zcid }").load('${baseurl }attend/selectTnameByTid.do?tid='+tid);
					                        </script>
			                        </td>
			                        
			                        <td >
			                           <span id="${item.zcid }1"></span>
				                        	<script type="text/javascript">
				                        		var zcid='${item.zcid}';
					                        		$("#${item.zcid }1").load('${baseurl }attend/selectGradeByZcid.do?zcid='+zcid);
					                        </script>
			                        </td>
			                       
			                        <td class="td-status">
			                            <span id="${item.zcid }2"></span>
				                        	<script type="text/javascript">
				                        		var zcid='${item.zcid}';
					                        		$("#${item.zcid }2").load('${baseurl }attend/selectMajorByZcid.do?zcid='+zcid);
					                        </script>
			                        </td>
			                        <td class="td-manage">
			                        点击查看
   
			                       <a title="设置班委" href="${baseurl }attend/selectAttendByCidPage.do?id=${item.zcid}" 
 			...
 			<div class="col-md-6">
				...
				<ul class="pagination">
					<li><a href="${APP_PATH }/attend/selectZclassByLike.do?pn=1&year=${year}&major=${major}&clazzs=${clazzs}">首页</a></li>
					<c:if test="${pageInfo.hasPreviousPage }">
						<li><a href="${APP_PATH }/attend/selectZclassByLike.do?pn=${pageInfo.pageNum-1}&year=${year}&major=${major}&clazzs=${clazzs}"
					...
					<c:forEach items="${pageInfo.navigatepageNums }" var="page_Num">
						...
						<c:if test="${page_Num != pageInfo.pageNum }">
							<li><a href="${APP_PATH }/attend/selectZclassByLike.do?pn=${page_Num }&year=${year}&major=${major}&clazzs=${clazzs}">${page_Num }</a></li>
						</c:if>
					...
					<li><a href="${APP_PATH }/attend/selectZclassByLike.do?pn=${pageInfo.pages}&year=${year}&major=${major}&clazzs=${clazzs}">末页</a></li>
				</ul>
				</nav>
			</div>          
